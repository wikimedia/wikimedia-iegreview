...
class ArrayTest extends \PHPUnit_Framework_TestCase {
	 ...
	 */
	public function testDifferenceException( $from, $to, $expectedAdd, $expectedRemove ) {
		$this->setExpectedException(
			'PHPUnit_Framework_Error', 'Argument 1 passed to Wikimedia\IEGReview\Arrays::difference() must be an instance of array, string given'
		);
		$diff = Arrays::difference( $from, $to );
		$toAdd = $diff['add'];
		$toRemove = $diff['remove'];
